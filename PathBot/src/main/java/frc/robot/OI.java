...
public class OI {
	...
	public final Button buttonA = new JoystickButton(controller, aButton);
	...
	private final Button startB = new JoystickButton(controller, startButton);
	private final Button leftStickB = new JoystickButton(controller, lStickButton);
	private final Button rightStickB = new JoystickButton(controller, rStickButton);
